  ...
  return (
      <section className='bg-[#ECF8F9] h-[660px]'>
        <div className="container flex flex-row mx-auto justify-center">
          <div className="left-expertice pr-[141px] ">
            <h5 className='mt-[142px] text-transform: uppercase text-[14px] leading-[20px] font-medium'>Our expertise</h5>
            <h1 className='text-[48px] leading-[58px] font-bold mt-[16px]'>
              We want to get local <br /> identification in every <br /> corner of the world
              in this <br /> era of global citizenship
            </h1>
            <p className='mt-[24px] text-[#5D5F6D]'>
              Through True Rich Attended does no end it his mother since real
              had half <br /> every him case in packages enquire we up ecstatic
          ...
          <div className="right-expertice mt-[96px] ">
           <div className="rocket w-[515px] h-[140px] bg-[#f1f1f1] border p-[32px] flex gap-4 items-start">
  ...
  <img src={rockt} className="w-6 h-6" />
     ...
     <div>
      ...
      had half every him.
           ...
           <div className="settings w-[515px] h-[140px] bg-[#f1f1f1] border p-[32px] flex gap-4 items-start">
...
<div className="supportt  w-[515px] h-[140px] bg-[#f1f1f1] border p-[32px] flex gap-4 items-start mt-3">
  <div className="w-12 h-12 bg-[#FFE0D3] rounded-full flex items-center justify-center">
 ...
 <div>
  ...
  {/* <div className="w-[515px] h-2 flex mt-7">
