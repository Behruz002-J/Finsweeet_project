...
// import call from '../../assets/icons/operator.svg'
// import settin from '../../assets/icons/settings.svg'
// import dev from '../../assets/icons/interval.svg'
//  import turn2 from "../../assets/icons/turn2.svg";
...
export default function Service() {
    return (
     ...
     <div className="service-text  w-[777px] h-[310px]  pt-[96px]">
       ...
       <div className="flex flex-row w-[214px] h-[64px] bg-[#444CFC] cursor-pointer hover:bg-orange-600 justify-center gap-[16px] mt-[40px]">
  <a href="" className="flex items-center gap-2 text-[#FFFFFF]">
    Start a project
    <img alt="turn2" className="w-4 h-4" />
  </a>
</div>
     </div>
    <div className="service-names flex flex-row gap-[32px] mx-auto mt-[18px] mt-[184px]">
        <div className="character  bg-[#FFFFFF] w-[405px] h-[335px] ">
         ...
         <div className="management   bg-[#FFFFFF] w-[405px] h-[335px]">
          <div className="mt-[48px] ml-[48px]">
              <img alt="" className="w-12 h-[48px] rounded-full object-cover border-blue-500 object-cover"/>
          </div>
            <h5 className="text-[#000000] font-semibold mt-[16px] pl-[48px]">Technical support</h5>
